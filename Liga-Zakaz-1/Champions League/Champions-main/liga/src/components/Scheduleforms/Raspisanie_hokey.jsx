    ...
    const fetchData = async () => {
      try {
        ...
        matches.each((index, element) => {
          ...
          const score = matchDiv.find('.teams  .score ').text().slice(0, 3);
                        ...
                        <div className="name">
                          <div className="img16">
                            <span className="span-baskets ">
                              <p>{match.team1.length > 30 ? match.team1.slice(0, 30) + '..' : match.team1}</p>
                            </span>
                          </div>
                        </div>
                        <div className="gls gls-basket ms-2"><p>{match.score}</p></div>
                      </div>
                      <div className="at pb-2">
                        <div className="name">
                          <div className="img16">
                            <span className="span-baskets">
                             <p> {match.team2.length > 30 ? match.team2.slice(0, 30) + '..' : match.team2}</p>
                            </span>
                          </div>
                        </div>
                      </div>
