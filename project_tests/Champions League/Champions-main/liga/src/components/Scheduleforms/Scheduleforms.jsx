      ...
      <div className="forms__sections">
        <div className="container-fluid pb-5 pt-4">
          ...
          {currentGames.map((game) => (
            ...
            <div key={game.id} className="forms_com-block">
                  ...
                  <div className="ht">
                    <div className="name">
                      ...
                      assName="img16">
                        ...
                        <img className='ms-2' loading="lazy" src={game.homeTeamLogo} alt={game.homeTeam} />
                      </div>
                    </div>
                    <div className="gls ms-2">{game.homeGoals}</div>
                  </div>
                  <div className="at pb-2">
                    <div className="name">
                      <div className="img16">
                        <img className='me-2' loading="lazy" src={game.awayTeamLogo} alt={game.awayTeam} />
                        <span>{game.awayTeam}</span>
                      </div>
                    </div>
                    <div className="gls me-2">{game.awayGoals}</div>
                  </div>
                </div>
