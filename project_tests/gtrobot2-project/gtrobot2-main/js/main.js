...
const loginForm = document.querySelector('.authorization_form');
...
loginForm.addEventListener('submit', function (event) {
	...
	let userPhone = document.querySelector('.loginInputPhone').value;
	let userPassword = document.querySelector('.loginInputPassword').value;
